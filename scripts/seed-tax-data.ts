...
// The phase-out / credit columns are nullable decimals: Drizzle wants a string,
// and the parser yields `number | null` for years the workbook doesn't cover.
const dec = (v: number | null | undefined) => (v != null ? String(v) : null);
...
async function upsertYear(y: TaxYearParameters, db: any) {
  await db
    ...
    .values({
      ...
      rothPhaseoutStartMfj: dec(y.rothPhaseout.startMfj),
      rothPhaseoutEndMfj: dec(y.rothPhaseout.endMfj),
      rothPhaseoutStartSingle: dec(y.rothPhaseout.startSingle),
      rothPhaseoutEndSingle: dec(y.rothPhaseout.endSingle),
      iraDeductCoveredStartMfj: dec(y.iraDeduct.coveredStartMfj),
      iraDeductCoveredEndMfj: dec(y.iraDeduct.coveredEndMfj),
      iraDeductCoveredStartSingle: dec(y.iraDeduct.coveredStartSingle),
      iraDeductCoveredEndSingle: dec(y.iraDeduct.coveredEndSingle),
      iraDeductSpousalStartMfj: dec(y.iraDeduct.spousalStartMfj),
      iraDeductSpousalEndMfj: dec(y.iraDeduct.spousalEndMfj),
      studentLoanMaxDeduction: dec(y.studentLoan.maxDeduction),
      studentLoanPhaseoutStartMfj: dec(y.studentLoan.startMfj),
      studentLoanPhaseoutEndMfj: dec(y.studentLoan.endMfj),
      studentLoanPhaseoutStartSingle: dec(y.studentLoan.startSingle),
      studentLoanPhaseoutEndSingle: dec(y.studentLoan.endSingle),
      ctcPerChild: dec(y.ctc.perChild),
      ctcRefundableMax: dec(y.ctc.refundableMax),
      odcPerDependent: dec(y.ctc.odcPerDependent),
      saversCreditTiersMfj: y.saversCredit.mfj,
      saversCreditTiersSingle: y.saversCredit.single,
      saversCreditTiersHoh: y.saversCredit.hoh,
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        rothPhaseoutStartMfj: sql`excluded.roth_phaseout_start_mfj`,
        rothPhaseoutEndMfj: sql`excluded.roth_phaseout_end_mfj`,
        rothPhaseoutStartSingle: sql`excluded.roth_phaseout_start_single`,
        rothPhaseoutEndSingle: sql`excluded.roth_phaseout_end_single`,
        iraDeductCoveredStartMfj: sql`excluded.ira_deduct_covered_start_mfj`,
        iraDeductCoveredEndMfj: sql`excluded.ira_deduct_covered_end_mfj`,
        iraDeductCoveredStartSingle: sql`excluded.ira_deduct_covered_start_single`,
        iraDeductCoveredEndSingle: sql`excluded.ira_deduct_covered_end_single`,
        iraDeductSpousalStartMfj: sql`excluded.ira_deduct_spousal_start_mfj`,
        iraDeductSpousalEndMfj: sql`excluded.ira_deduct_spousal_end_mfj`,
        studentLoanMaxDeduction: sql`excluded.student_loan_max_deduction`,
        studentLoanPhaseoutStartMfj: sql`excluded.student_loan_phaseout_start_mfj`,
        studentLoanPhaseoutEndMfj: sql`excluded.student_loan_phaseout_end_mfj`,
        studentLoanPhaseoutStartSingle: sql`excluded.student_loan_phaseout_start_single`,
        studentLoanPhaseoutEndSingle: sql`excluded.student_loan_phaseout_end_single`,
        ctcPerChild: sql`excluded.ctc_per_child`,
        ctcRefundableMax: sql`excluded.ctc_refundable_max`,
        odcPerDependent: sql`excluded.odc_per_dependent`,
        saversCreditTiersMfj: sql`excluded.savers_credit_tiers_mfj`,
        saversCreditTiersSingle: sql`excluded.savers_credit_tiers_single`,
        saversCreditTiersHoh: sql`excluded.savers_credit_tiers_hoh`,
