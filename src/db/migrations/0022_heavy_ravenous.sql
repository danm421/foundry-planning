...
CREATE TYPE "public"."extra_payment_type" AS ENUM('per_payment', 'lump_sum');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "expense_schedule_overrides" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"expense_id" uuid NOT NULL,
	"year" integer NOT NULL,
	"amount" numeric(15, 2) NOT NULL,
	CONSTRAINT "expense_schedule_year_uniq" UNIQUE("expense_id","year")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "income_schedule_overrides" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"income_id" uuid NOT NULL,
	"year" integer NOT NULL,
	"amount" numeric(15, 2) NOT NULL,
	CONSTRAINT "income_schedule_year_uniq" UNIQUE("income_id","year")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "savings_schedule_overrides" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"savings_rule_id" uuid NOT NULL,
	"year" integer NOT NULL,
	"amount" numeric(15, 2) NOT NULL,
	CONSTRAINT "savings_schedule_year_uniq" UNIQUE("savings_rule_id","year")
);
--> statement-breakpoint
...
ALTER TABLE "liabilities" ADD COLUMN "balance_as_of_month" integer;--> statement-breakpoint
ALTER TABLE "liabilities" ADD COLUMN "balance_as_of_year" integer;--> statement-breakpoint
ALTER TABLE "liabilities" ADD COLUMN "start_month" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "liabilities" ADD COLUMN "start_year_ref" "year_ref";--> statement-breakpoint
ALTER TABLE "liabilities" ADD COLUMN "term_months" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "liabilities" ADD COLUMN "term_unit" text DEFAULT 'annual' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "expense_schedule_overrides" ADD CONSTRAINT "expense_schedule_overrides_expense_id_expenses_id_fk" FOREIGN KEY ("expense_id") REFERENCES "public"."expenses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "extra_payments" ADD CONSTRAINT "extra_payments_liability_id_liabilities_id_fk" FOREIGN KEY ("liability_id") REFERENCES "public"."liabilities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "income_schedule_overrides" ADD CONSTRAINT "income_schedule_overrides_income_id_incomes_id_fk" FOREIGN KEY ("income_id") REFERENCES "public"."incomes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "savings_schedule_overrides" ADD CONSTRAINT "savings_schedule_overrides_savings_rule_id_savings_rules_id_fk" FOREIGN KEY ("savings_rule_id") REFERENCES "public"."savings_rules"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
