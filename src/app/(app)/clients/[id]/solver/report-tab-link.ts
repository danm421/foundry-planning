...
export type ReportKey = "portfolio" | "cashflow" | "taxBracket" | "lifeInsurance" | "estate" | "monteCarlo" | "summaries";

/** The four left-pane input tabs. */
export type InputTab = "retirement" | "techniques" | "stress_test" | "life_insurance";
