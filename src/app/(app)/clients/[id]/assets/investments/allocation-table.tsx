          ...
          {rows.map((t) => {
            ...
            return (
              <tr
                ...
                className="cursor-pointer border-b border-hair hover:bg-card-hover"
              >
      ...
      <table className="w-full text-left text-xs">
        ...
        <tbody>
          {household.byAssetType.map((t) => {
            ...
            return (
              <Fragment key={t.id}>
                <tr className="border-b border-hair bg-card-2/60 font-semibold">
                  <td className="px-2 py-2 text-ink">
                    <span className="mr-2 inline-block h-2 w-2 rounded-sm" style={{ backgroundColor: typeColor }} />
                    {t.label}
                  </td>
                  <td className="px-2 py-2 text-right tabular-nums text-ink">{dollars(t.value)}</td>
                  <td className="px-2 py-2 text-ink">
                ...
                {classesInType.map((c, idx) => {
                  ...
                  return (
                    <tr
                      ...
                      className="cursor-pointer border-b border-hair hover:bg-card-hover"
                    >
                      <td className="px-2 py-2 pl-6 text-ink">
                        <span className="mr-2 inline-block h-2 w-2 rounded-sm" style={{ backgroundColor: color }} />
                        {c.name}
                      </td>
                      <td className="px-2 py-2 text-right tabular-nums text-ink">
...
function BarCell({ pct: p, color }: { pct: number; color: string }) {
  return (
    <div className="flex items-center justify-end gap-2">
      <div className="h-1.5 w-16 overflow-hidden rounded bg-card-2">
...
function UnallocatedRow({
  ...
  return (
    <tr
      ...
      className="cursor-pointer italic text-ink-3 hover:bg-card-hover"
    >
