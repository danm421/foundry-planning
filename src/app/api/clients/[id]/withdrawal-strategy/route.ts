...
import { db } from "@/db";
import { scenarios, withdrawalStrategies } from "@/db/schema";
...
export async function POST(
  ...
  try {
    ...
    await recordAudit({
      ...
      clientId: id,
      firmId,
      metadata: crossFirmAuditMeta({ access }, callerOrg, { accountId: strategy.accountId, priorityOrder: strategy.priorityOrder }),
    });
