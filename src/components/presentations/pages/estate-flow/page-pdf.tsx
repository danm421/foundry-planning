...
const styles = StyleSheet.create({
  ...
  column: { flex: 1, borderWidth: 0.5, borderColor: T.hair, borderRadius: 4, padding: 8 },
  ...
  groupCard: { borderWidth: 0.5, borderColor: T.hair, borderRadius: 3, padding: 5, marginBottom: 5 },
  ...
  reductFooter: { flexDirection: "row", justifyContent: "space-between", borderTopWidth: 0.5, borderTopColor: T.hair, marginTop: 3, paddingTop: 2 },
