...
const styles = StyleSheet.create({
  ...
  ooeBox: { borderRadius: 4, padding: 8, borderWidth: 1, borderColor: T.hair, backgroundColor: T.card },
  ...
  heirTotalRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 3, borderTopWidth: 0.5, borderTopColor: T.hair, paddingTop: 2 },
