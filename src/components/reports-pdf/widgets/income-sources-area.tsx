...
//
// PDF render for the incomeSourcesArea widget. Receives a pre-rendered
// PNG data-URI via `chartImage` (the builder snapshots the live Chart.js
// canvas before posting to the export route). Falls back to a placeholder
// string when the snapshot is missing — better than failing the whole
// export when a single chart can't be captured.
...
export function IncomeSourcesAreaPdfRender({
  props,
  chartImage,
}: WidgetRenderProps<"incomeSourcesArea">) {
  return (
    <View style={s.wrap}>
