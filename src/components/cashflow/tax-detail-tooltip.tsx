    ...
    <span className="inline-flex items-center gap-1">
      ...
      >
        ...
        {open && (
          <span
            role="tooltip"
            className="absolute top-full left-1/2 z-50 mt-1 w-64 -translate-x-1/2 rounded-md border border-ink-3 bg-gray-900 px-3 py-2 text-xs font-normal text-gray-200 shadow-lg"
          >
            {text}
          </span>
        )}
