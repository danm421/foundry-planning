...
const FACTOR_ORDER: { key: keyof CapacityFactors; label: string; help: string }[] = [
  {
    key: "horizon",
    label: "Time horizon",
    help: "Years from today to the end of the plan. A longer runway leaves more time to recover from a bad market. Nothing at 0 years, full marks at 30 or more.",
  },
  {
    key: "buffer",
  ...
  },
  {
    ...
    help: "The share of retirement spending covered by Social Security and pensions, averaged over the years those benefits are actually paid. This income does not depend on the markets. Full marks once it covers all spending.",
  },
];
