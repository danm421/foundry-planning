...
const NEUTRAL = "border-hair text-ink-2 bg-card-2";
const WARN = "border-warn/40 text-warn bg-warn/10";

const CHIP_SPECS: { key: keyof RiskListFlags; label: string; className: string }[] = [
  { key: "notEstablished", label: "Not established", className: NEUTRAL },
  { key: "reviewDue", label: "Review due", className: NEUTRAL },
  { key: "capacityConstrained", label: "Capacity-constrained", className: WARN },
  { key: "goalsOverReaching", label: "Goals over-reaching", className: WARN },
  { key: "capacityPending", label: "Capacity pending", className: NEUTRAL },
];
