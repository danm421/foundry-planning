...
/**
 * The signed-out page frame: ambient glow, Foundry lockup, legal footer.
 * Shared by /sign-in, /sign-up, /beta (max-w-md) and /welcome (max-w-5xl),
 * which needs room for the form and the live report preview side by side.
 */
