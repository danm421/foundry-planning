  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <input
        ...
        className="h-1 w-48 cursor-pointer appearance-none rounded bg-paper accent-accent"
      />

      <span className="min-w-[3.5rem] text-sm font-semibold tabular-nums text-ink">
        {isToday ? "Today" : value}
      </span>
      ...
      <button
        ...
        disabled={isToday}
        className="rounded border border-hair px-2 py-0.5 text-xs font-medium text-ink-3 transition-colors hover:text-ink disabled:cursor-not-allowed disabled:opacity-40"
      >
        Today
      </button>
    </div>
