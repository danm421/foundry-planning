  ...
  return (
    <section className="rounded-lg bg-slate-900/60 ring-1 ring-slate-800 overflow-hidden">
      <div className="flex items-baseline justify-between px-4 pt-4">
        ...
        <span className="text-xs text-slate-400">Percentile balances by year</span>
      </div>
      <div className="overflow-x-auto mt-3">
        <table className="w-full text-sm">
          <thead>
            <tr className="text-xs uppercase tracking-wider text-slate-300">
              ...
              <th className="px-4 py-2 text-right font-medium text-slate-400">CAGR</th>
