...
const groups = [
  { id: "g-food", name: "Food", slug: "food", color: "var(--data-orange)", budget: null, budgetIsExplicit: false, unallocated: 0, actual: 230, remaining: null, leaves: [] },
  { id: "g-shop", name: "Shopping", slug: "shopping", color: "var(--data-purple)", budget: null, budgetIsExplicit: false, unallocated: 0, actual: 0, remaining: null, leaves: [] },
];
