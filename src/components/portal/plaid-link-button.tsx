...
export function PlaidLinkButton(props: Props) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={busy}
      className="inline-flex items-center gap-2 rounded-md bg-accent px-4 py-2 text-[13px] font-medium text-accent-on shadow-sm hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {label}
    </button>
  );
