export const TAX_FORM_CLASSIFIER_VERSION = "2026-08-06.1";
...
Identify the pages containing these forms when present: Form 1040 (both pages), Schedules 1, 2, 3, A, B, C, D, E, K-1 (every one attached), Form 8995/8995-A, Form 8959, Form 8960, and the FIRST page of any attached state return. Exclude instructions, worksheets, e-file cover sheets, and preparer notes.
