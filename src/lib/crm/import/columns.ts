...
export const FIELD_LABELS: Record<ImportField, string> = {
  ...
  spouseFirst: "Co-client first name",
  spouseLast: "Co-client last name",
  spouseEmail: "Co-client email",
  spouseDob: "Co-client date of birth",
  status: "Status",
  notes: "Notes",
...
const ALIASES: Record<ImportField, readonly string[]> = {
  ...
  spouseFirst: ["spouse first", "spouse first name", "spouse", "partner first name", "spouse given name", "co client first", "co client first name", "co client", "co client given name"],
  spouseLast: ["spouse last", "spouse last name", "spouse surname", "partner last name", "co client last", "co client last name", "co client surname"],
  spouseEmail: ["spouse email", "spouse email address", "partner email", "co client email", "co client email address"],
  spouseDob: ["spouse dob", "spouse date of birth", "spouse birth date", "partner dob", "co client dob", "co client date of birth", "co client birth date"],
