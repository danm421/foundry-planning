  ...
  return {
    ...
    accounts: [
      { id: "a1", name: "Brokerage", category: "taxable", growthSource: "asset_mix",
        modelPortfolioId: null, tickerPortfolioId: null, value: 100, ownerEntityId: null, entityInPortfolio: false },
      { id: "a2", name: "IRA", category: "retirement", growthSource: "model_portfolio",
        modelPortfolioId: "mp1", tickerPortfolioId: null, value: 50, ownerEntityId: null, entityInPortfolio: false },
    ],
    assetClassLites: [
...
describe("buildInvestmentsResolver", () => {
  it("resolves an asset_mix account to its stored weights", () => {
    ...
    const result = resolver({ id: "a1", category: "taxable", growthSource: "asset_mix", modelPortfolioId: null, tickerPortfolioId: null });
  ...
  it("resolves a model_portfolio account to the portfolio's weights", () => {
    const b = fixture();
    const resolver = buildInvestmentsResolver(b);
    const result = resolver({ id: "a2", category: "retirement", growthSource: "model_portfolio", modelPortfolioId: "mp1", tickerPortfolioId: null });
