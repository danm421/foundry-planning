...
const py = (year: number, g: Partial<import("@/engine/types").EducationGoalYear>): ProjectionYear =>
  ({ year, educationGoals: [{ goalId: "edu", dedicatedAssetsBOY: 0, growthAndSavings: 0, goalExpense: 0, otherExpenseFlows: 0, dedicatedWithdrawal: 0, dedicatedAssetsEOY: 0, shortfall: 0, ...g }] } as ProjectionYear);
