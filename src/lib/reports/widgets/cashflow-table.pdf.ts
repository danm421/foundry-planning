// src/lib/reports/widgets/cashflow-table.pdf.ts
//
// PDF-side registration glue for the cashflowTable widget. Imported as
...
import { CashflowTablePdfRender } from "@/components/reports-pdf/widgets/cashflow-table";

registerWidgetPdf("cashflowTable", CashflowTablePdfRender);
