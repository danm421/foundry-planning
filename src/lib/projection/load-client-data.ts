      ...
      resolveAccountFromRaw(
        {
          ...
          noteInterestRate: a.noteInterestRate,
          noteTermMonths: a.noteTermMonths,
          noteStartYear: a.noteStartYear,
          notePaymentType: a.notePaymentType,
          noteLinkedTrustEntityId: a.noteLinkedTrustEntityId,
        },
        resolutionCtx,
      ),
    );
